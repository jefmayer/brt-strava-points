        ...
        <main>
          ...
          <div>
            ...
            <div className="max-w-7xl mx-auto py-6">
              <h2 className="font-extrabold mb-3 text-6xl text-center text-red-500">The chase is always on.</h2>
            ...
            <div className="items-center flex max-w-7xl mx-auto">
              ...
              <div className="w-1/2 flex justify-center">
                <div className="max-w-80">
                  <h2 className="font-extrabold mb-3 text-6xl text-red-500">How <a href="https://www.strava.com/athletes/760273" className="underline hover:no-underline">Alex</a> claims it works:</h2>
